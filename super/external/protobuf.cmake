...
if(NOT TARGET protobuf-project)
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND
      ...
      # Protobuf installs using `CMAKE_INSTALL_LIBDIR`, as it should, which
      # expands to `lib` or `lib64`. But hard-codes RPATH to `$ORIGIN/../lib`,
      # so change the default `LIBDIR` to something that works.
