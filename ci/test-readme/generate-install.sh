...
cat <<'END_OF_PREAMBLE'
# Obtaining google-cloud-cpp-pubsub

There are two primary ways of obtaining `google-cloud-cpp-pubsub`. You can use git:

```bash
git clone git@github.com:googleapis/google-cloud-cpp-pubsub.git $HOME/project
```
...
wget -q https://github.com/googleapis/google-cloud-cpp-pubsub/archive/v0.1.0.tar.gz
tar -xf v0.1.0.tar.gz -C $HOME/project --strip=1
```

# Installing google-cloud-cpp-pubsub

When built with Bazel or as a CMake super build `google-cloud-cpp-pubsub`
...
**If** all the dependencies of `google-cloud-cpp-pubsub` are installed and
...
the following sections describe how to install `google-cloud-cpp-pubsub` on
several platforms.

## Using `google-cloud-cpp-pubsub` in CMake-based projects.

Once you have installed `google-cloud-cpp-pubsub` you can use the libraries from
...
## Using `google-cloud-cpp-pubsub` in Make-based projects.

Once you have installed `google-cloud-cpp-pubsub` you can use the libraries in
...
## Using `google-cloud-cpp-pubsub` in Bazel-based projects.

If you use `Bazel` for your builds you do not need to install
`google-cloud-cpp-pubsub`. We provide a Starlark function to automatically
download and compile `google-cloud-cpp-pubsub` as part of you Bazel build. Add
...
http_archive(
    ...
    url = "http://github.com/googleapis/google-cloud-cpp-pubsub/archive/v0.2.0.tar.gz",
...
cc_binary(
    ...
    deps = [
        "@com_github_googleapis_google_cloud_cpp_pubsubr//google/cloud/pubsub:pubsub_client",
    ],
)
```
