...
if (NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
    file(READ
         ...
         RELEASE_MODULE)
    string(
        REPLACE "\${_IMPORT_PREFIX}/bin/protoc${EXECUTABLE_SUFFIX}"
...
if (NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
    ...
    string(REPLACE "\${_IMPORT_PREFIX}" "\${_IMPORT_PREFIX}/debug" DEBUG_MODULE
                   "${DEBUG_MODULE}")
    string(
        REPLACE "\${_IMPORT_PREFIX}/debug/bin/protoc${EXECUTABLE_SUFFIX}"
                "\${_IMPORT_PREFIX}/tools/protobuf/protoc${EXECUTABLE_SUFFIX}"
                DEBUG_MODULE "${DEBUG_MODULE}")
    file(WRITE
         ${CURRENT_PACKAGES_DIR}/share/protobuf/protobuf-targets-debug.cmake
         "${DEBUG_MODULE}")
endif ()
