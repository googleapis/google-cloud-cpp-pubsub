...
readonly INTEGRATION_TESTS_CONFIG="/c/pubsub-integration-tests-config.sh"
if [[ "${RUN_INTEGRATION_TESTS}" == "yes" || \
  ...
  export GOOGLE_APPLICATION_CREDENTIALS=/c/pubsub-credentials.json
...
if [[ "${TEST_INSTALL:-}" = "yes" ]]; then
    ...
    if comm -23 \
        ...
        <(echo "$HOME/staging/include/google/cloud" ; \
          echo "$HOME/staging/include/google/cloud/pubsub" ; \
          echo "$HOME/staging/include/google/cloud/pubsub/internal" ; \
          echo "$HOME/staging/include/google/cloud/pubsub/mocks" ; \
